...
def msgsss(client, m):
 try:
  ...
  triggers2 = ['подсрачник', 'нервы', 'смысл', 'психику', 'свою психику', 'мамку', 'отношения']
  print(sp)
  maintext = None
  mainact = None
  texts = []
...
def ragna():
    threading.Timer(random.randint(300, 600), ragna).start()
    try:
      with bot1:
        ...
        bot1.send_message(-1001175617321, 'Мы готовы')
        time.sleep(20)
        bot1.send_message(-1001175617321, 'сос')
